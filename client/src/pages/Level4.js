...
const Level4 = () => {
  ...
  const hints = [
    ...
    "💡 Hint: Check for unnatural breath patterns or missing breath sounds.",
    "💡 Hint: Pay attention to consonant clarity - AI may struggle with sharp sounds.",
    "💡 Hint: Notice any repetitive patterns or loops in background noise.",
    "💡 Hint: Listen for slight timing inconsistencies in speech rhythm."
  ];
      ...
      try {
        ...
        for (let i = 0; i < 5; i++) {
          ...
          if (response.ok) {
            ...
            console.log(`Level 4 - Question ${i + 1}: Random value = ${randomValue}, Fake on left = ${fakeOnLeft}`);
        ...
        console.log('Level 4 - Final questions list:', questionsList);
  ...
  const handleChoice = async (side) => {
    ...
    try {
      ...
      console.log(`Level 4 - User chose: ${side}, Fake is on: ${question.fakeOnLeft ? 'left' : 'right'}`);
      ...
      console.log(`Level 4 - Chosen fake: ${chosenFake}`);
  ...
  return (
    <>
      ...
      <div className="level-decorations">
        <div className="floating-audio-level" style={{left: '7%', top: '22%', animationDelay: '1.5s'}}>🎚️</div>
        <div className="floating-audio-level" style={{left: '87%', top: '15%', animationDelay: '3.5s'}}>🎧</div>
        <div className="floating-audio-level" style={{left: '18%', top: '75%', animationDelay: '5.5s'}}>🔊</div>
        <div className="floating-audio-level" style={{left: '78%', top: '85%', animationDelay: '2.5s'}}>🎵</div>
        <div className="floating-audio-level" style={{left: '35%', top: '5%', animationDelay: '4.5s'}}>🎤</div>
      </div>
      ...
      <div className="level-container">
        {questionsLoading ? (
          <div className="loading-container">
            ...
            <p>🎚️ Preparing expert audio challenges from Codecfake dataset...</p>
          ...
          <>
            <h2>Level 4 – Question {current + 1} of {questions.length} 🔊</h2>
            ...
            {!completed ? (
              ...
              <div className="completion-block">
                <h3>You've completed Level 4! 🎉</h3>
