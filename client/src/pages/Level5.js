...
const Level5 = () => {
  ...
  const hints = [
    "💡 Hint: Listen for spectral inconsistencies in higher frequencies.",
    "💡 Hint: Check for unnatural vocal tract modeling artifacts.",
    "💡 Hint: Pay attention to formant frequency irregularities.",
    "💡 Hint: Notice any digital aliasing in the voice spectrum.",
    "💡 Hint: Listen for phase coherence issues between vocal harmonics."
  ];
      ...
      try {
        ...
        for (let i = 0; i < 5; i++) {
          ...
          if (response.ok) {
            ...
            console.log(`Level 5 - Question ${i + 1}: Random value = ${randomValue}, Fake on left = ${fakeOnLeft}`);
        ...
        console.log('Level 5 - Final questions list:', questionsList);
  ...
  const handleChoice = async (side) => {
    ...
    try {
      ...
      console.log(`Level 5 - User chose: ${side}, Fake is on: ${question.fakeOnLeft ? 'left' : 'right'}`);
      ...
      console.log(`Level 5 - Chosen fake: ${chosenFake}`);
  ...
  return (
    <>
      ...
      <div className="level-decorations">
        <div className="floating-audio-level" style={{left: '9%', top: '24%', animationDelay: '2s'}}>📊</div>
        <div className="floating-audio-level" style={{left: '85%', top: '12%', animationDelay: '4s'}}>🎧</div>
        <div className="floating-audio-level" style={{left: '20%', top: '80%', animationDelay: '6s'}}>🔊</div>
        <div className="floating-audio-level" style={{left: '76%', top: '90%', animationDelay: '3s'}}>🎵</div>
        <div className="floating-audio-level" style={{left: '30%', top: '2%', animationDelay: '5s'}}>🎤</div>
      </div>

      <div className="level-container">
        {questionsLoading ? (
          <div className="loading-container">
            <h2>Loading Level 5...</h2>
            <p>📊 Preparing professional audio challenges from Codecfake dataset...</p>
          ...
          <>
            <h2>Level 5 – Question {current + 1} of {questions.length} 🔊</h2>
            ...
            {!completed ? (
              ...
              <div className="completion-block">
                <h3>You've completed Level 5! 🎉</h3>
